...
/**
 * changeDirDot - changes to the parent directory
 *
...
/**
 * changeDirTo - changes to a directory given
 * by the user
 *
...
/**
 * changeDirPrev - changes to the previous directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
...
/**
 * changeDirToHome - changes to home directory
 *
 * @datash: data relevant (environ)
 * Return: no return
 */
